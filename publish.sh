...
# docker build --build-arg PYTHON_VERSION=3.6 -f python-base-alpine.Dockerfile -t vprotasenia/devforth-drone-builder:python3.6-alpine .
# docker push vprotasenia/devforth-drone-builder:python3.6-alpine
